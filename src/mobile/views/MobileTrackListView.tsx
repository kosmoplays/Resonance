...
export function MobileTrackListView({
  ...
  return (
    <div className="h-full w-full flex flex-col bg-neutral-950 text-white select-none relative overflow-hidden">
      {/* STICKY TOP HEADER */}
      <header className="sticky top-0 z-30 flex items-center justify-between px-4 py-2.5 pt-[env(safe-area-inset-top,10px)] bg-neutral-950/80 backdrop-blur-2xl border-b border-white/10 flex-shrink-0">
      ...
      {/* SCROLLABLE CONTENT */}
      <div className="flex-1 overflow-y-auto pb-[calc(env(safe-area-inset-bottom,0px)+80px)] px-3 scrollbar-none">
